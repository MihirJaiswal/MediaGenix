              ...
              {imageUrl && (
                <div>
                  ...
                  <button
                    ...
                    className="mt-4 w-full bg-teal-500 text-black py-3 px-4 rounded-lg text-lg font-medium hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-400 transition-all"
                  >
                    Download Image
                  </button>
                </div>
